...
public class Mensaje_3 extends javax.swing.JFrame {
    BaseA bs = new BaseA();
    ...
    public Mensaje_3() {
         ...
         // Notification obj = new Notification(this, WindowPosition.BOTTOMRIGHT, 740, 450, 5000); // horizontal , vertical, tiempo
    ...
    public Mensaje_3(TercerAgente aThis) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EL AGENTE SUGIERE: ");
        ...
        TablaMensaje.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"se debe hacer un análisis en el los productos del puerto Antofagasta en la gestión 2016"},
                {"y se debeb hacer un análisis en los precios FOB de esos productos"}
            },
            new String [] {
                "Debido a los cambios en los productos NANDINA "
            }
        ));
        jScrollPane1.setViewportView(TablaMensaje);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 530, 130));
        jPanel1.add(txtBuscarBas2, new org.netbeans.lib.awtextra.AbsoluteConstraints(264, 180, 0, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 100, 220));
