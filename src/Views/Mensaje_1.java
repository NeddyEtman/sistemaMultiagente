...
public class Mensaje_1 extends javax.swing.JFrame {
    BaseA bs = new BaseA();
    ...
    public Mensaje_1() {
          ...
          val.add(obj);
          BaseAControllers base = new BaseAControllers(bs, bsDao, this); // pone informacion al cuadro
  }

    public Mensaje_1(TercerAgente aThis) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtBuscarBas2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 0, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 510, 210));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/AgenteMP.png"))); // NOI18N
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 0, 100, 220));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("las bases de datos fueron");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 60, 190, 20));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Los cambios mas importantes ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 20, 220, 20));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("desde la última actualización de ");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 40, 200, 20));
